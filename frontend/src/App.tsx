...
const Setup = () => (
  <div className="bg-card border border-border/60 rounded-3xl p-8 shadow-soft">
    <h1 className="text-2xl font-extrabold tracking-tight text-white mb-2">Organization Setup</h1>
    <p className="text-muted-foreground text-sm">Configure departments, asset categories, and assign roles.</p>
  </div>
);

const Assets = () => (
  <div className="bg-card border border-border/60 rounded-3xl p-8 shadow-soft">
    <h1 className="text-2xl font-extrabold tracking-tight text-white mb-2">Asset Directory</h1>
    <p className="text-muted-foreground text-sm">Track, search, and register company hardware and resources.</p>
  </div>
);

const Allocations = () => (
  <div className="bg-card border border-border/60 rounded-3xl p-8 shadow-soft">
    <h1 className="text-2xl font-extrabold tracking-tight text-white mb-2">Asset Allocation</h1>
    <p className="text-muted-foreground text-sm">Manage asset assignments, handovers, and history.</p>
  </div>
);
